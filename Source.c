...
void vvod_array1(int a[], int n)
{
	...
	printf("введите массив состоящий из целых чисел\n");
...
void linear_search(int a[], int n, int *nc)
{
	...
	for (i = 0; i < n; i++)
	{
		*nc = *nc + 1;
		if (a[i] == k)    
		{
			printf("элемент %d находится на %d позиции\n", k, i + 1);
			break;
		}
	}
	*nc = *nc + 1;
...
{
	{
		...
		printf("1. сгенерировать новый массив автоматически\n");
		printf("2. ввести массив вручную\n");

		printf("\n3. вывести массив на экран\n");

		printf("\nвыберите способ поиска элементов\n");
		printf("4. линейный поиск\n");
		printf("5. бинарный поиск (только если массив уже отсортирован)\n");

		printf("\nвыберите способ сортировки массива\n");
		printf("6. шейкерная сортировка\n");
		printf("7. сортировка вставками\n");
		printf("8. сортировка слиянием\n");
